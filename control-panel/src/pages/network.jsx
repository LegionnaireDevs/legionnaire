    ...
    <div className="h-full w-full flex flex-col overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
        ...
        <div className="w-full max-w-7xl mx-auto px-6 pb-6 flex-1 flex flex-col min-h-0">
                ...
                <div className="flex-shrink-0">
                    <table className="w-full table-fixed">
                        <thead className="bg-gradient-to-r from-purple-600/30 to-blue-600/30 border-b border-white/10">
                            <tr>
                                <th className="w-3/12 px-6 py-4 text-left text-sm font-semibold text-white uppercase tracking-wider">Source IP</th>
                                <th className="w-3/12 px-6 py-4 text-left text-sm font-semibold text-white uppercase tracking-wider">Destination IP</th>
                                <th className="w-2/12 px-6 py-4 text-left text-sm font-semibold text-white uppercase tracking-wider">Source Port</th>
                                <th className="w-2/12 px-6 py-4 text-left text-sm font-semibold text-white uppercase tracking-wider">Destination Port</th>
                                <th className="w-2/12 px-6 py-4 text-left text-sm font-semibold text-white uppercase tracking-wider">Detected Type</th>
                            </tr>
                        </thead>
                    </table>
                </div>
                ...
                <div className="overflow-y-auto flex-grow">
                    {networkData.length === 0 && !loading ? (
                        <div className="flex justify-center items-center h-full">
                            <p className="text-gray-400 text-xl">No malicious network traffic detected.</p>
                        </div>
                    ) : (
                        <table className="w-full table-fixed">
