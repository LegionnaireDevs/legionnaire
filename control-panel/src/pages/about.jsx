    ...
    <div className="min-h-screen w-screen relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="relative z-10 flex flex-col items-center justify-start min-h-screen w-full p-8 pt-16">
        ...
        <div className="text-center mb-12">
          <h1
            className={`text-5xl md:text-7xl font-black mb-6 transition-all duration-1000 transform ${
              titleVisible
          ...
          >
            ...
            <br />
            <span
              className={`bg-gradient-to-r from-white via-blue-100 to-purple-100 bg-clip-text text-transparent transition-all duration-1000 delay-500 ${
        ...
        {/* Main description */}
        <div
          className={`max-w-4xl mx-auto text-center mb-16 transition-all duration-1000 delay-700 ${
            isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
          }`}
        >
          <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
            <p className="text-xl md:text-1xl text-blue-100 leading-relaxed mb-6">
              Legionnaire is an AI-powered SIEM (Security Information and Event
              Management) platform designed for comprehensive, automated threat
              detection and response. It operates as a modular, GUI-less system
              running in the background, consisting of a client and a control
              server.
            </p>
        ...
        {/* Features Grid */}
        <div
          className={`w-full max-w-7xl transition-all duration-1000 delay-1000 transform ${
            featuresVisible
              ? "translate-y-0 opacity-100"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="group backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl hover:scale-105 hover:bg-white/10 transition-all duration-300">
              ...
              <p className="text-slate-300 text-lg leading-relaxed">
                Captures network traffic and performs feature analysis using
                machine learning to identify suspicious network activity in
                real-time.
              </p>
            </div>
            ...
            <div className="group backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl hover:scale-105 hover:bg-white/10 transition-all duration-300">
              ...
              <p className="text-slate-300 text-lg leading-relaxed">
                Monitors and analyzes system logs on Windows, Linux, and Mac to
                detect anomalous or potentially harmful events across all
                platforms.
              </p>
            </div>
            ...
            <div className="group backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl hover:scale-105 hover:bg-white/10 transition-all duration-300">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-orange-100">
                  Program Analysis
                </h3>
              </div>
              <p className="text-slate-300 text-lg leading-relaxed">
                Hashes all running executables on the device and compares them
                against external threat databases to detect malicious programs
                in real time.
              </p>
            </div>
            ...
            <div className="group backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl hover:scale-105 hover:bg-white/10 transition-all duration-300">
              ...
              <p className="text-slate-300 text-lg leading-relaxed">
                Acts as a defense and response system, capable of blocking
                network attacks via a firewall and terminating or removing
                malicious files on command.
              </p>
            </div>
          </div>
        </div>
