            ...
            <div className="flex-shrink-0 bg-black/20 backdrop-blur-lg rounded-t-xl border border-b-0 border-white/10">
                <table className="w-full table-fixed">
                    <thead className="bg-gradient-to-r from-purple-600/30 to-blue-600/30">
                        <tr>
                            <th className="w-2/12 px-6 py-4 text-left text-sm font-semibold text-white uppercase tracking-wider">Endpoint ID</th>
                            <th className="w-4/12 px-6 py-4 text-left text-sm font-semibold text-white uppercase tracking-wider">Endpoint Name</th>
                            <th className="w-3/12 px-6 py-4 text-left text-sm font-semibold text-white uppercase tracking-wider">Endpoint IP</th>
                            <th className="w-3/12 px-6 py-4 text-left text-sm font-semibold text-white uppercase tracking-wider">Actions</th>
                        </tr>
                    </thead>
                </table>
            </div>
                            ...
                            clients.map((client) => (
                                <tr key={client.id} className="hover:bg-white/5 transition-colors duration-200 group">
                                    ...
                                    <td className="w-4/12 px-6 py-4 text-center">
                                        <div className="text-white font-medium group-hover:text-blue-300 transition-colors">{client.hostname}</div>
                                    </td>
                                    <td className="w-3/12 px-6 py-4 whitespace-nowrap">
                                        <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-500/20 text-purple-300 border border-purple-500/30">{client.ip}</span>
                                    </td>
                                    <td className="w-3/12 px-6 py-4 whitespace-nowrap">
                                        <button
