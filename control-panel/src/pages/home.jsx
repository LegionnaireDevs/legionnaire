    ...
    <div className="min-h-screen w-screen relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen w-full p-8">
        ...
        <div className="text-center mb-16">
          <h1
            className={`text-6xl md:text-8xl font-black mb-6 transition-all duration-1000 transform ${
              titleVisible
          ...
          >
            ...
            <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
              Legionnaire is an AI-powered SIEM that provides automated,
              background threat detection and response through a modular
          ...
          <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl w-full">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                <h3 className="text-lg md:text-xl text-slate-300 mb-4 tracking-wide font-bold">
                  Active Clients
                </h3>
                <div className="text-4xl md:text-5xl font-black text-green-400 mb-4">
                  47
                </div>
                <div className="flex justify-center space-x-1">
                  {[...Array(8)].map((_, i) => (
                    <div
                      key={i}
                      className={`h-6 bg-green-500/70 rounded animate-pulse`}
                      style={{
              ...
              <div className="text-center">
                ...
                <div className="text-4xl md:text-5xl font-black text-red-400 mb-4">
                  1,247
                </div>
                <div className="flex justify-center space-x-1">
                  {[...Array(8)].map((_, i) => (
                    <div
                      key={i}
                      className={`h-6 bg-red-500/70 rounded animate-pulse`}
                      style={{
                        width: Math.random() * 15 + 8 + "px",
              ...
              <div className="text-center">
                ...
                <div className="text-4xl md:text-5xl font-black text-orange-400 mb-4">
                  192
                </div>
                <div className="flex justify-center space-x-1">
                  {[...Array(8)].map((_, i) => (
                    <div
                      key={i}
                      className={`h-6 bg-orange-500/70 rounded animate-pulse`}
                      style={{
                        width: Math.random() * 15 + 8 + "px",
        ...
        >
          <div className="flex items-center space-x-2 text-slate-400 animate-bounce"></div>
        </div>
      </div>
